...
- featured
---
I recently published a post about [my first year of being an independent iPhone development consultant](http://brandontreb.com/learned-first-year-ios-consulting).  The feedback from my readers was incredible, however there was one important thread on Hacker News that I wanted to address.  The issues were:
...
I very quickly registered the domain [icodeblog.com](http://icodeblog.com) and setup WordPress.  This led to my very [first post](http://www.icodeblog.com/2008/07/22/icodeblog-launched/) in July of 2008. I had no idea what I was doing; it was my first blog ever, but I knew I would be able to learn more effectively if I was teaching others as I went along.
...
I wrote [this blog post](http://brandontreb.com/what-i-learned-in-my-first-month-being-a-contract-ios-developer) documenting that very first month.
...
*This post is part of a series about becoming and independent software consultant.  I am participating in this series with my good friend Josh. [You can read his take on this post here](http://joshuastephenson.com/2014/02/06/on-becoming-an-independent-software-consultant/).*
